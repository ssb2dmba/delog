...
public class Sodium {
    ...
    public static void sodium_free(SWIGTYPE_p_void ptr) {
        SodiumJNI.sodium_free(SWIGTYPE_p_void.getCPtr(ptr));
    }

    public static SWIGTYPE_p_void sodium_malloc(int size) {
        long cPtr = SodiumJNI.sodium_malloc(size);
        return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
    }

    public static int crypto_pwhash_str_needs_rehash(byte[] str, int opslimit, int memlimit) {
        return SodiumJNI.crypto_pwhash_str_needs_rehash(str, opslimit, memlimit);
    }

...
public class SodiumJNI {
    ...
    public final static native void sodium_free(long jarg1);

    public final static native long sodium_malloc(int jarg1);

    public final static native int crypto_pwhash_str_needs_rehash(byte[] jarg1, int jarg2, int jarg3);
}

...
public final class DiffieHelman {
    ...
    public static final class PublicKey {
        ...
        public static PublicKey forBoxPublicKey(Box.PublicKey publicKey) {
            return new PublicKey(SodiumUtils.dup(publicKey.value.bytesArray(), length()), length());
        }
    ...
    public static final class SecretKey implements Destroyable {
        ...
        public static SecretKey forBoxSecretKey(Box.SecretKey secretKey) {
            return new SecretKey(SodiumUtils.dup(secretKey.value.bytesArray(), length()), length());
        }
    ...
    public static final class KeyPair {
        ...
        public static KeyPair random() {
            return SodiumUtils.randomBytes(SecretKey.length(), (ptr, len) -> forSecretKey(new SecretKey(ptr, len)));
        }
        ...
        @Override
        public int hashCode() {
            return Objects.hash(publicKey.bytes().toHexString(), secretKey.bytes().toHexString());
        }
    }
    ...
    public static final class Secret implements Destroyable {
        ...
        private Secret(byte[] ptr, int length) {
            this.value = new Allocated(ptr, length);
        }
        ...
        public static Secret fromBytes(byte[] bytes) {
            ...
            return SodiumUtils.dup(bytes, Secret::new);
        }

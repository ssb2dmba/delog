...
fun parity(_sum: Int, v: Int, n: Int): Int {
    var sum = _sum
...
fun privateToMnemonic(sk: ByteArray, dict: Dict): List<String> {
...
fun mnemonicToSeed(phrase: List<String>, dict: Dict): Signature.KeyPair? {
